...
#sys.path.append("C:\\Users\\k_suzuki\\Documents\\src\\chainer-semi-supervised\\vat.py")
sys.path.append("lib/")

from vat import KL_multinominal,VATLossClassifier,VATUpdater

# Network definition

class MLP_cnn(chainer.Chain):
...
def main():
    ...
    test_iter = chainer.iterators.SerialIterator(tuple_test, args.batchsize,
    ...
    updater=VATUpdater(train_l_iter,train_ul_iter, optimizer, device=args.gpu)
    #updater.first_iter()
    ...
    if args.plot and extensions.PlotReport.available():
        trainer.extend(
            extensions.PlotReport(['main/loss', 'validation/main/loss'],
                                  'epoch', trigger=(50,'epoch'),file_name='loss.png'))
        trainer.extend(
            extensions.PlotReport(
                ['main/accuracy', 'validation/main/accuracy'],
                'epoch', trigger=(50,'epoch'),file_name='accuracy.png'))
